...
# -*- coding: utf-8 -*-
#
# django-simple-elasticsearch documentation build configuration file, created by
...
html_theme_options = {
   ...
   'github_repo': 'django-simple-elasticsearch',
   'github_banner': True
}
...
release = simple_elasticsearch.__version__
...
htmlhelp_basename = 'simple_elasticsearchdoc'
